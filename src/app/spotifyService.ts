...
export class spotifyService {
  ...
  getPlaylists() : Observable<any> {
   let local_url='http://localhost:3001/api/playlists'
  ...
  getProfile() : Observable<any> {
    let local_url='http://localhost:3001/api/me'
    let heroku_url='https://spotify-statistics-app.herokuapp.com/api/me'
    return this.http.get<any>(heroku_url)

  }
  getTopArtists(time_range:string) : Observable<any> {
    let local_url='http://localhost:3001/api/me/top/artists?time_range='+time_range
  ...
  getSavedTracks(offset:number=0) : Observable<any> {
    let local_url='http://localhost:3001/api/me/top/tracks?offset='+ offset
  ...
  getTrackFeatures(id) : Observable<any> {
    let local_url='http://localhost:3001/api/audio-features?trackId=' + id
    let heroku_url='https://spotify-statistics-app.herokuapp.com/api/audio-features?trackId=' + id
    return this.http.get<any>(heroku_url)

  }
  getTrack(id) : Observable<any> {
    let local_url='http://localhost:3001/api/track?trackId=' + id
